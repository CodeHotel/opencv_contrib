#ifndef OPENCV_STREAM_HELPER_HPP
#define OPENCV_STREAM_HELPER_HPP
...
// -----------------------------------------------------------------------------
// StreamHelper orchestrator
// -----------------------------------------------------------------------------

class CV_EXPORTS_W StreamHelper {
public:
    CV_WRAP StreamHelper();
    ~StreamHelper();
    ...
    StreamHelper(StreamHelper&&) noexcept;
    StreamHelper& operator=(StreamHelper&&) noexcept;
...
CV_EXPORTS_W std::unique_ptr<StreamHelper> createStreamHelper();
...
#endif // OPENCV_STREAM_HELPER_HPP
